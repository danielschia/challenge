...
ActiveRecord::Schema.define(version: 2020_10_24_202743) do
  ...
  create_table "solicitations", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["solicitante_id"], name: "index_solicitations_on_solicitante_id"
  end

  add_foreign_key "solicitations", "solicitantes"
end
